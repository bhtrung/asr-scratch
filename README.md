...
# Data preparation
## Audio data
Use Amazon Mechanical Turk to collect audio files as a training and test set if you don't have them. For example: `data/audio/train` and `data/audio/test` are two folders contain the collected .wav files from the data queries. Each file has the following format: TurkerID_QueryID_Word1_Word2_..._WordN.wav. 
